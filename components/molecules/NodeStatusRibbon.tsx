...
import { getNodeState, getTitle, getTitleBgColor, getTitleTextColor } from './NodeStatus'
...
export const NodeStatusRibbon = () => {
  ...
  const { showModal, setShowModal, setContent } = useModalStore((state: any) => ({
  ...
  return (
    <div className="mt-20">
      ...
      <div className="hidden">
        <span className="bg-successBg text-xl text-successFg border border-b-successBorder">1</span>
        <span className="bg-severeBg text-xl text-severeFg border border-b-severeBorder">2</span>
        <span className="bg-attentionBg text-xl text-attentionFg border border-b-attentionBorder">3</span>
        <span className="bg-subtleBg text-xl text-subtleFg border border-b-subtleBg">4</span>
        <span className="bg-dangerBg text-xl text-dangerFg border border-b-dangerBorder">5</span>
        <span className="bg-subtleBg text-xl text-subtleFg border border-b-subtleBg">6</span>
        <span className="bg-selectedBg text-xl text-selectedFg border border-b-selectedBg">7</span>
        <span className="bg-readyBg text-xl text-readyFg border border-b-readyBg">8</span>
      </div>
      <div className={`h-12 shadow flex items-center bg-${titleBgColor} border border-b-${borderColor}`}>
        <div className={`flex justify-between w-full items-center text-xs gap-x-2 p-3 font-semibold`}>
