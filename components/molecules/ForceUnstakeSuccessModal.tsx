...
export const ForceUnstakeSuccessModal = ({ stake, rewards }: ForceUnstakeSuccessModalProps) => {
    ...
    <div className="bg-white text-subtleFg flex flex-col p-4 max-w-sm w-full rounded">
      <div className="flex flex-col items-center gap-y-3">
        ...
        <span className="text-sm text-dangerFg text-center">
          You lost <span className="font-semibold">{rewards.toFixed(2)} SHM</span> earned during current stake due to
          force removal of stake.
        </span>
        <hr className="mt-1 w-full" />
