          ...
          <div className="flex">
            <div className="flex flex-col grow gap-x-3">
              <div className="text-sm font-semibold">
                <ErrorIcon className="rounded-full h-14 w-14 p-2 inline" fillColor="rgb(178, 161, 0)" />
                No Genesis Node License Detected
              </div>
              <div className="flex flex-col justify-start mt-1 mx-4">
                <span className="bodyFg">
                  In the beginning, you need to have a <b>Genesis Node license</b> in order to join as a validator on
                  Shardeum.
                </span>
                <span className="bodyFg">
                  If you have a <b>Genesis Node license</b>, please make sure you are connected to the correct wallet.
                </span>
                ...
                <div className="flex justify-end">
                  ...
                  >
                    <button className="w-full px-3 py-2 rounded text-sm bg-primary text-white">Purchase License</button>
                  </a>
                </div>
              </div>
            </div>
