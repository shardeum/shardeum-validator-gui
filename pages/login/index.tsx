...
const Login = () => {
  ...
  if (authService.isLogged) {
    const onboardingCompleted = localStorage.getItem(onboardingCompletedKey) === 'true'
      ...
      <div className="w-screen flex center">
        ...
        >
          <div className="flex flex-col items-center mb-20 ml-20 gap-y-8">
            <span className={'break-normal max-w-sm font-medium text-xl ' + GeistSans.className}>
          ...
          <main className={`grow px-6 pt-24 md:p-20 h-full`}>
            <div className="flex flex-col gap-y-8 h-full">
              ...
              <Title
                ...
                className={GeistSans.className + ' text-3xl font-semibold text-gray-900 max-w-[400px]'}
              />
